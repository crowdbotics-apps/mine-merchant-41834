"""
Django settings for mine_merchant_41834 project.
...
ROOT_URLCONF = 'mine_merchant_41834.urls'
...
WSGI_APPLICATION = 'mine_merchant_41834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mine_merchant_41834 API",
    "DESCRIPTION": "API documentation for mine_merchant_41834 App",
    "VERSION": "v1",
}
